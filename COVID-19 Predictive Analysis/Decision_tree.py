...
def dt(file,forecast):
    ...
    # B = plt.boxplot(X_train['PEOPLE_POSITIVE_CASES_COUNT'])
    ...
    # models = pd.DataFrame({
    #     "Method": ['LinearRegression', 'KNeighborsRegressor', 'RandomForestRegressor', 'Lasso', 'ElasticNet', 'DecisionTreeRegressor'],
    #     "Scores":[score[0],score[1],score[2],score[3],score[4],score[5]]})
